...
# --- 설정 ---
original_csv_path = 'users.csv'  # 원본 CSV 파일 경로
output_csv_path = 'users_korean_name.csv' # 새롭게 생성될 CSV 파일 경로
# --- 설정 끝 ---

def generate_korean_data(input_csv_path, output_csv_path):
    try:
    ...
    for _ in range(len(df)):
        new_name = firstName() + LastName() + LastName()
    ...
    print(f"'{output_csv_path}'에 변경사항 저장")

if __name__ == "__main__":
    generate_korean_data(original_csv_path, output_csv_path)